...
import brand from '../../assets/companies/sakhaaCharity.png';
import charityImg from '../../assets/charity.png';
import charityIcon1 from '../../assets/icons/charityIcon1.png';
import charityIcon2 from '../../assets/icons/charityIcon2.png';
import charityIcon3 from '../../assets/icons/charityIcon3.png';
import charityIcon4 from '../../assets/icons/charityIcon4.png';
...
class Charity extends Component {
    ...
    render(){
     ...
     {/* <h1>width: {this.state.widthPort}</h1> */}
             ...
             <main className="CharityContainer">
             <div className="BackToHome" style={{paddingLeft : "3rem"}}>
             <NavLink to="/ar/about/profile" exact>
                       ...
                       <div className="BrandContent">
                            ...
                            <div className="BrandText">
                               <Row className="mb-5">
                                    <Col lg={2}>
                                        <div className="Icon">
                                            <img src={charityIcon1} alt="icon1" />
                                        </div>
                                    </Col>
                                    <Col lg={10}>
                                        <div className="IconText">
                                            <p>
                                            خدمات اجتماعيةخدمات اجتماعيةخدمات اجتماعيةخدمات اجتماعيةخدمات اجتماعيةخدمات اجتماعية
                                            </p>
                                        </div>
                                    </Col>
                               </Row>
                               <Row className="mb-5">
                                    <Col lg={2}>
                                        <div className="Icon">
                                            <img src={charityIcon2} alt="icon1" />
                                        </div>
                                    </Col>
                                    <Col lg={10}>
                                        <div className="IconText">
                               ...
                               <Row className="mb-5">
                                    <Col lg={2}>
                                        <div className="Icon">
                                            <img src={charityIcon3} alt="icon1" />
                                        </div>
                                    </Col>
                                    <Col lg={10}>
                                        <div className="IconText">
                               ...
                               <Row className="mb-5">
                                    <Col lg={2}>
                                        <div className="Icon">
                                            <img src={charityIcon4} alt="icon1" />
                                        </div>
                                    </Col>
                                    <Col lg={10}>
                                        <div className="IconText">
