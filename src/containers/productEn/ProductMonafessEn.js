...
import alMounafess from '../../assets/brands/AlMounafess.png';
import {Row, Col} from 'react-bootstrap';
import './ProductAhliaEn.css';
import MonafesProduct from '../../assets/products/MonafesProduct.png';
...
class ProductMonafessEn extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
             ...
             {backLink}
                ...
                <Row>
                    ...
                    <div className="ProductBrand">
                          <img src={alMounafess} alt="alMounafess" />
                          </div>
                    <div className="ProductHeader">
                        <p>
                            <b>Al Mounafes Rice</b>
                            It is characterized by a very competitive price and high quality that combines the length of the grain, the ease of cooking, and the wonderful shape and taste in order to be served to its competitive customers.
                            </p>
                        </div>
                    ...
                    <Col lg={7}>
                        ...
                        <img src={MonafesProduct} alt={altImg} />
                        </div>
                    </Col>
                </Row>
                ...
                <Slider {...settings}>
                <div>
                   <NavLink to={{pathname:"/en/ahlia/4", previous:{name: "/en/ahlia/3", previous: this.props.location.previous.name}}} exact> <img src={riceDafa} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/5", previous:{name: "/en/ahlia/3", previous: this.props.location.previous.name}}} exact> <img src={riceGhassen} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/3", previous:{name: "/en/ahlia/3", previous: this.props.location.previous.name}}} exact> <img src={riceMonafes} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/6", previous:{name: "/en/ahlia/3", previous: this.props.location.previous.name}}} exact> <img src={riceWatani} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/1", previous:{name: "/en/ahlia/3", previous: this.props.location.previous.name}}} exact> <img src={riceWhite} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/2", previous:{name: "/en/ahlia/3", previous: this.props.location.previous.name}}}exact> <img src={riceSakhaa} alt={altImg} /></NavLink>
                    </div>
...
export default ProductMonafessEn;