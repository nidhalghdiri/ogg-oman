...
import pasta1Product from '../../assets/products/pasta1Product.png';
...
import bgProductTitle from '../../assets/icons/bgProductTitle6.png';
...
class Pasta1Product extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
    ...
    render(){
     ...
     {/* <h1>width: {this.state.widthPort}</h1> */}
             ...
             <NavLink to={{pathname:"/ar/sakhaa/pasta", previous:{name: backLink}}} exact>
                ...
                <Row>
                    <Col lg={5}>
                        ...
                        <img src={pasta1Product} alt={altImg} />
                        </div>
                    </Col>
                    <Col lg={7}>
                    ...
                    <div className="ProductBrand">
                          ...
                          style={{backgroundImage: "url('"+ bgProductTitle +"')"}}>
                              <h1 style={{fontSize: "0.8rem"}}>مكرونة سخاء الهلالية</h1>
                          </div>
                        <p>
                        مكرومنة سخاء يتم إنتاجها من أجود أنواع القمح القاسي في العالم ويتم تجهيزها في احدى أكبر واشهر مصانع تجهيز المكرونه في العالم  نقدمها لك بحب لتصبح جزاء رئيسي من مائدتك ....خبراء صناعة المكرونه.
                       </p>
                        </div>
                        <Row>
                        <Col lg={12}>
                    <div className="ProductCaract" style={{alignItems: "center"}}>
                    <Table responsive hover size="sm"  >
                        <tbody >
                            ...
                            <td>
                                <span>مكرونة ســخــــاءالهلالية</span>
                            </td>
                            ...
                            <td>
                                <span>مكرونة رفيعة درجة أولى</span>
                            </td>
                            ...
                            <td >
                                <div className="kgs">
                                    <div className="kg"><span>400G</span></div>
                                </div>
                            </td>
