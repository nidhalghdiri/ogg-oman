...
import AlDaffa from '../../assets/brands/Raka.png';
import {Row, Col, Table} from 'react-bootstrap';
import './ProductAhlia.css';
import wafer3Product from '../../assets/products/wafer3Product.png';
...
import bgProductTitle from '../../assets/icons/bgProductTitle3.png';
...
class ProductWafer3 extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
    ...
    render(){
     ...
     {/* <h1>width: {this.state.widthPort}</h1> */}
             ...
             <NavLink to={{pathname:"/ar/raka", previous:{name: backLink}}} exact>
                ...
                <Row>
                    <Col lg={5}>
                        ...
                        <img src={wafer3Product} alt={altImg} />
                        </div>
                    </Col>
                    <Col lg={4}>
                    ...
                    <Table responsive hover size="sm" >
                        <tbody>
                            ...
                            <td >
                                <div className="kgs">
                                    <div className="kg"><span>1KG</span></div>
                                    <div className="kg"><span>5KG</span></div>
                                    <div className="kg"><span>9KG</span></div>
                                    <div className="kg"><span>20KG</span></div>
                                    <div className="kg"><span>40KG</span></div>
                                </div>
                            </td>
