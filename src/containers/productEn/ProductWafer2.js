...
import wafer2Product from '../../assets/products/wafer2Product.png';
...
import bgProductTitle from '../../assets/icons/bgProductTitle2.png';
             ...
             <NavLink to={{pathname:"/ar/raka", previous:{name: backLink}}} exact>
                ...
                <Row>
                    <Col lg={5}>
                        ...
                        <img src={wafer2Product} alt={altImg} />
                        </div>
                    </Col>
                    <Col lg={4}>
                    ...
                    <Col lg={3}>
                          ...
                          style={{backgroundImage: "url('"+ bgProductTitle +"')"}}>
                              <h1 style={{fontSize: "0.8rem"}}>ويفر راكا بالفول السوداني</h1>
                          </div>
