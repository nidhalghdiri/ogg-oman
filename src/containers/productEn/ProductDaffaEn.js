...
class ProductDaffaEn extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
             ...
             {backLink}
                ...
                <Row>
                    ...
                    <div className="ProductHeader">
                          ...
                          <p>
                            <b>Al Dafa Rice </b>
                            is hand-picked from the best types of rice; it is characterized by a long grain, a special price and its great taste, whereby a unique dish that everyone appetizes ready to be served.
                            </p>
                        </div>
                ...
                <Slider {...settings}>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/4", previous:{name: "/en/ahlia/4", previous: this.props.location.previous.name}}} exact> <img src={riceDafa} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/5", previous:{name: "/en/ahlia/4", previous: this.props.location.previous.name}}} exact> <img src={riceGhassen} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/3", previous:{name: "/en/ahlia/4", previous: this.props.location.previous.name}}} exact> <img src={riceMonafes} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/6", previous:{name: "/en/ahlia/4", previous: this.props.location.previous.name}}} exact> <img src={riceWatani} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/1", previous:{name: "/en/ahlia/4", previous: this.props.location.previous.name}}} exact> <img src={riceWhite} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/2", previous:{name: "/en/ahlia/4", previous: this.props.location.previous.name}}}exact> <img src={riceSakhaa} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   {/* <NavLink to={{pathname:"/en/ahlia/7", previous:{name: "/en/ahlia/4", previous: this.props.location.previous.name}}}exact> <img src={riceSamaha} alt={altImg} /></NavLink> */}
                    </div>
