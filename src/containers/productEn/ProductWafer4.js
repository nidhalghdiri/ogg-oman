...
import wafer4Product from '../../assets/products/wafer4Product.png';
...
import bgProductTitle from '../../assets/icons/bgProductTitle4.png';
             ...
             <NavLink to={{pathname:"/ar/raka", previous:{name: backLink}}} exact>
                ...
                <Row>
                    <Col lg={5}>
                        ...
                        <img src={wafer4Product} alt={altImg} />
                        </div>
                    </Col>
                    <Col lg={4}>
                    ...
                    <Col lg={3}>
                          ...
                          style={{backgroundImage: "url('"+ bgProductTitle +"')"}}>
                              <h1 style={{fontSize: "0.8rem"}}>ويفر راكا بالشكولاطة</h1>
                          </div>
