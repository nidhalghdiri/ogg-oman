...
import pasta2Product from '../../assets/products/pasta2Product.png';
             ...
             <NavLink to={{pathname:"/ar/sakhaa/pasta", previous:{name: backLink}}}exact>
                ...
                <Row>
                    <Col lg={5}>
                        ...
                        <img src={pasta2Product} alt={altImg} />
                        </div>
                    </Col>
                   <Col lg={7}>
                   ...
                   <div className="ProductBrand">
                          ...
                          style={{backgroundImage: "url('"+ bgProductTitle +"')"}}>
                              <h1 style={{fontSize: "0.8rem"}}>مكرونة سخاء السباجيتي</h1>
                          </div>
                        <p>
                    ...
                    <Table responsive hover size="sm" >
                        <tbody>
                            ...
                            <td>
                                <span>مكرونة سخاء السباجيتي</span>
                            </td>
