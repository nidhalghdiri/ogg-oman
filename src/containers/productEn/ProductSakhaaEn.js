...
import SakhaaProduct from '../../assets/products/sakhaaProduct.png';
...
class ProductSakhaaEn extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
    ...
    render(){
        var settings = {
            ...
            let altImg = "Ahlia Product";
            let backLink ='';
            
            if(this.props.location.previous === undefined){
                this.props.location.previous = { name: "home"}; 
            }
            if(this.props.location.previous.name === 'ahlia'){
                backLink = "/en/ahlia";
            }else if(this.props.location.previous.name === 'sakhaa'){
                backLink = "/en/sakhaa";
            }else{
      ...
      return(
        ...
        <SideBar open={this.state.search} clicked={this.searchOpen} />
             ...
             <NavLink to={backLink} exact>
                ...
                <Row>
                    ...
                    <Col lg={5}>
                        <div className="ProductBrand">
                            <img src={sakhaa} alt="sakhaa" />
                        </div>
                        <div className="ProductHeader">
                        <p>
                            <b>Sakha Rice</b>
                            is a special hand-picked rice with great care. It is characterized by the extra length of the grain and its attractive shape, to add to your dish and occasions an exquisite specificity and suits all tastes and meals, such as Zurbian (meat with rice), white rice, Biryani, Mandi (meat and rice) and others.
                            </p>
                        </div>
                        ...
                        <p>
                            ...
                            Soak the rice in moderately hot water close to warm for 30 minutes, then put the cooking pot filled with mineral water on a high heat until bubbles appear that indicate boiling, then remove the rice from the soaked water carefully and then put it in boiling water for 8 to 10 minutes only and then it's ready to be served.
                            </p>
                        </div>
                    ...
                    <Col lg={7}>
                        ...
                        <img src={SakhaaProduct} alt={altImg} />
                        </div>
                    </Col>
                </Row>
                ...
                <Slider {...settings}>
                <div>
                   <NavLink to={{pathname:"/en/ahlia/4", previous:{name: "/en/ahlia/2", previous: this.props.location.previous.name}}} exact> <img src={riceDafa} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/5", previous:{name: "/en/ahlia/2", previous: this.props.location.previous.name}}} exact> <img src={riceGhassen} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/3", previous:{name: "/en/ahlia/2", previous: this.props.location.previous.name}}} exact> <img src={riceMonafes} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/6", previous:{name: "/en/ahlia/2", previous: this.props.location.previous.name}}} exact> <img src={riceWatani} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/1", previous:{name: "/en/ahlia/2", previous: this.props.location.previous.name}}} exact> <img src={riceWhite} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/2", previous:{name: "/en/ahlia/2", previous: this.props.location.previous.name}}}exact> <img src={riceSakhaa} alt={altImg} /></NavLink>
                    </div>
...
export default ProductSakhaaEn;