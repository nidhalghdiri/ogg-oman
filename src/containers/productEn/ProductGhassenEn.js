...
class ProductGhassenEn extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
             ...
             {backLink}
                ...
                <Row>
                   ...
                   <div className="ProductHeader">
                        ...
                        <p>
                            <b>Al Ghassan Rice</b>
                            Al-Ghassan rice is a selection of high-quality and long-grain rice to suit all tastes, with its distinctive taste and aroma, to be serve to your happy family at all times.
                            </p>
                        </div>
                ...
                <Slider {...settings}>
                <div>
                   <NavLink to={{pathname:"/en/ahlia/4", previous:{name: "/en/ahlia/5", previous: this.props.location.previous.name}}} exact> <img src={riceDafa} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/5", previous:{name: "/en/ahlia/5", previous: this.props.location.previous.name}}} exact> <img src={riceGhassen} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/3", previous:{name: "/en/ahlia/5", previous: this.props.location.previous.name}}} exact> <img src={riceMonafes} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/6", previous:{name: "/en/ahlia/5", previous: this.props.location.previous.name}}} exact> <img src={riceWatani} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/1", previous:{name: "/en/ahlia/5", previous: this.props.location.previous.name}}} exact> <img src={riceWhite} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/en/ahlia/2", previous:{name: "/en/ahlia/5", previous: this.props.location.previous.name}}}exact> <img src={riceSakhaa} alt={altImg} /></NavLink>
                    </div>
...
export default ProductGhassenEn;