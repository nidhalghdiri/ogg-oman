...
class TrucksEn extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
            ...
            <Row>
                <Col lg={6}>
                    <div className="ProductsText">
                        ...
                        The company owns a fleet of modern trucks (80 trucks). They include all features to preserve and guarantee the safety of products when transporting them to remote places.
                        </p>
                    </div>
                </Col>
                <Col lg={6}>
                <div className="TrucksImgs">
                       <img src={trucksImgs} alt="imgs" onClick={() => this.openModalSlidesHandler('item1', 'الموظفين')} />
                    </div>
                </Col>
