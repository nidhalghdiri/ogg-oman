...
class HomeAr extends Component {
    state = {
        ...
        modalItems: [
            {id: 0, name: 'نبذة عنا',
            icon : aboutImg3 ,
            url: "/ar/about/profile",
            sousContent: 'العالمية الشاملة شركة كبير تنشط في عدة مجالات أهمها المواد الغذائية...' ,
             ...
             {id: 1, name: 'خبرة لأكثر من 30 سنة ',
             icon: aboutImg2,
             url: "/ar/about/history",
              sousContent: 'مجموعة العالمية الشاملة   قصة نجاح بدأت قبل أكثر من إثنان وثلاثون عاما ...' , content: ` العالمية الشاملة شركة كبير تنشط في مجالات عدة لعلى أهمها  المواد الغذائية ، حيث تظم الشركة مجموعة شركات و مؤسسات ذات صبغة تجارية و إجتماعية تتفوزع على مناطق من اليمن و سلطنة عمان لعلى أهمه  مؤسسة العالمية الشاملة  لاستيراد المواد الغذائية, شركة العليا  و الأفق الواضح و جمعية سخاء الخيرية.
             ...
             {id: 2, name: ' رؤيتنا',
             icon: aboutImg1,
             url: "/ar/about/message",
              sousContent: 'نعمل لإرساء جودة لمنتجانا من خلال نخبة من الخبراء ذوي الكفاءة العالية...' , content: "نعمل لإرساء جودة لمنتجانا من خلال نخبة من الخبراء ذوي الكفاءة العالية، تجمعنا قيم وأهداف سامية، يحفزنا الإيمان والتحدي لتقديم تجربة فريدة لعملائنا تؤسس لشراكة طويلة الأمد لتلبية احتياج المستهلكين ومنافسة الشركات من خلال الإستمرار الدائم بتقديم المنتجات ذات الجودة العالية"}
        ...
        companies : [
            {id: 0, name: 'الأفق', img: oufuq, iconName: 'icon3', icon: icon3, url : "/ar/oufuq", brands: [
            ...
            {id: 1, name: 'العليا', img: alia, iconName: 'icon2', icon: icon2 , url : "/ar/alia",
            products : [
                {id: 0, name: "Monafes" , icon : riceMonafes, content: riceMonafesContent},
                {id: 1, name: "Sakhaa" , icon : riceSakhaa, content: riceSakhaaContent},
                {id: 2, name: "White Rose" , icon : riceWhite, content: riceMonafesContent},
            ...
            {id: 2, name: 'الأهلية', img: ahlia, iconName: 'icon1', icon: icon1, url : "/ar/ahlia", 
                products : [
                    {id: 0, name: "Monafes" , icon : riceMonafes, content: riceMonafesContent},
                    {id: 1, name: "Sakhaa" , icon : riceSakhaa, content: riceSakhaaContent},
                    {id: 2, name: "White Rose" , icon : riceWhite, content: riceMonafesContent},
            ...
            {id: 3, name: 'العالمية الشاملة للتجارة العامة', img: logo, iconName: 'icon1', icon: icon1, url : "/ar", 
                products : [
                    {id: 0, name: "Monafes" , icon : riceMonafes, content: riceMonafesContent},
                    {id: 1, name: "Sakhaa" , icon : riceSakhaa, content: riceSakhaaContent},
                    {id: 2, name: "White Rose" , icon : riceWhite, content: riceMonafesContent},
        ...
        agencies : [
            {id: 0, name:"kap", img: kap, class: "Cap", url : "/ar/kapnera"},
    ...
    render () {
        ...
        return(
            <Aux>
               ...
               {/* <ModalProduct sakhaaPasta={this.state.sakhaaPasta} 
                             
                              sakhaaOil={this.state.sakhaaOil}  
                              sakhaaModal={this.state.sakhaaModal} 
                              sakhaaClicked={this.onClickRoseHandler} 
                              pastaClicked={this.onClickPastaHandler}
                              pasta2Clicked={this.onClickPasta2Handler}
                              sakhaaOilClicked={this.onClickOilHandler} 
        ...
        {/* <h1>width: {this.state.widthPort}</h1> */}
                <Navbar show={this.state.widthPort > 768 ? true : this.state.toggle} lien={false} lang={lang} selected={this.navItemSelected} /> 
               ...
               <Agencies open={this.openModalAgenciesHandler}  clicked={this.openModalAgencyHandler} agencies={this.state.agencies} id="agenciesSection" />
                </main>
                <FooterSection />
