...
class WataniProduct extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
                ...
                <Row>
                    ...
                    <div className="ProductHeader">
                          ...
                          style={{backgroundImage: "url('"+ bgProductTitle +"')"}}>
                              <h1>حبات الأرز الي بتحبها</h1>
                          </div> */}
                        <p>
                            <b>أرز الوطني</b>
                            ارز مخصص للمطاعم والحفلات والمناسبات وذلك لطولة الإضافي وسهولة طبخه وسعرة المميز جدا طيب لاخر حبة.
                            </p>
                        </div>
...
لمدة 30 دقيقة ثم يوضع قدر الطبخ المملوى  بالماء المعدني على نار مرتفعة الي ان تعلوة الفقاعات التي تدل على الغليان ثم نقوم بتشيف الارز من الماء المنقع بشكل دقيق ثم يوضع في الماء المغلي لمدة من 8 الي 10 دقائق فقط ويكون بعدها جاهز للتقديم.
                ...
                <Slider {...settings}>
                <div>
                   <NavLink to={{pathname:"/ar/ahlia/4", previous:{name: "/ar/ahlia/6", previous: this.props.location.previous.name}}} exact> <img src={riceDafa} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/5", previous:{name: "/ar/ahlia/6", previous: this.props.location.previous.name}}} exact> <img src={riceGhassen} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/3", previous:{name: "/ar/ahlia/6", previous: this.props.location.previous.name}}} exact> <img src={riceMonafes} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/6", previous:{name: "/ar/ahlia/6", previous: this.props.location.previous.name}}} exact> <img src={riceWatani} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/1", previous:{name: "/ar/ahlia/6", previous: this.props.location.previous.name}}} exact> <img src={riceWhite} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/2", previous:{name: "/ar/ahlia/6", previous: this.props.location.previous.name}}}exact> <img src={riceSakhaa} alt={altImg} /></NavLink>
                    </div>
