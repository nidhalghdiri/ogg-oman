...
import wafer1Product from '../../assets/products/wafer1Product.png';
...
class ProductWafer1 extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
             ...
             <NavLink to={{pathname:"/ar/raka", previous:{name: backLink}}} exact>
                ...
                <Row>
                    <Col lg={5}>
                        ...
                        <img src={wafer1Product} alt={altImg} />
                        </div>
                    </Col>
                    <Col lg={4}>
