...
import aLGhassan from '../../assets/brands/ALGhassan.png';
import {Row, Col} from 'react-bootstrap';
import './ProductAhlia.css';
import GhassenProduct from '../../assets/products/ghassenProduct.png';
...
class ProductGhassen extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
             ...
             {backLink}
                ...
                <Row>
                    <Col lg={7}>
                        ...
                        <img src={GhassenProduct} alt={altImg} />
                        </div>
                    </Col>
                   <Col lg={5}>
                   <div className="ProductBrand">
                          <img src={aLGhassan} alt="aLGhassan" />
                          </div>
                   <div className="ProductHeader">
                          {/* <div className="ProductTitle" 
                          style={{backgroundImage: "url('"+ bgProductTitle +"')"}}>
                             <h1>الطعم على أصوله</h1>
                          </div> */}
                        <p>
                            <b>أرز الغسان</b>
                            تشكيلة منتقاه من الأرز عالي الجودة وطويل الحبه ليناسب جميع الاذواق بطعمه المميز ورائحتة الذكية قدمه لعائلتك السعيده في كل الاوقات.
                            </p>
                        </div>
...
لمدة 30 دقيقة ثم يوضع قدر الطبخ المملوى  بالماء المعدني على نار مرتفعة الي ان تعلوة الفقاعات التي تدل على الغليان ثم نقوم بتشيف الارز من الماء المنقع بشكل دقيق ثم يوضع في الماء المغلي لمدة من 8 الي 10 دقائق فقط ويكون بعدها جاهز للتقديم.
                ...
                <Slider {...settings}>
                <div>
                   <NavLink to={{pathname:"/ar/ahlia/4", previous:{name: "/ar/ahlia/5", previous: this.props.location.previous.name}}} exact> <img src={riceDafa} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/5", previous:{name: "/ar/ahlia/5", previous: this.props.location.previous.name}}} exact> <img src={riceGhassen} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/3", previous:{name: "/ar/ahlia/5", previous: this.props.location.previous.name}}} exact> <img src={riceMonafes} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/6", previous:{name: "/ar/ahlia/5", previous: this.props.location.previous.name}}} exact> <img src={riceWatani} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/1", previous:{name: "/ar/ahlia/5", previous: this.props.location.previous.name}}} exact> <img src={riceWhite} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/2", previous:{name: "/ar/ahlia/5", previous: this.props.location.previous.name}}}exact> <img src={riceSakhaa} alt={altImg} /></NavLink>
                    </div>
