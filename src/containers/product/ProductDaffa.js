...
import AlDaffa from '../../assets/brands/AlDaffa.png';
import {Row, Col} from 'react-bootstrap';
import './ProductAhlia.css';
import daffaProduct from '../../assets/products/daffaProduct.png';
...
class ProductDaffa extends Component {
    state = {
        search: false,
        toggle: false,
        navDrop: false,
             ...
             {backLink}
                ...
                <Row>
                    <Col lg={7}>
                        ...
                        <img src={daffaProduct} alt={altImg} />
                        </div>
                    </Col>
                    <Col lg={5}>
                    ...
                    <div className="ProductHeader">
                          ...
                          <p>
                            <b>أرز الدفة</b>
                            منتقى من أفضل أنواع الأرز يتميز بحبة طويلة وسعر مميز وطعم رائع ليقدم طبق فريد يحبه الجميع.
                            </p>
                        </div>
...
لمدة 30 دقيقة ثم يوضع قدر الطبخ المملوى  بالماء المعدني على نار مرتفعة الي ان تعلوة الفقاعات التي تدل على الغليان ثم نقوم بتشيف الارز من الماء المنقع بشكل دقيق ثم يوضع في الماء المغلي لمدة من 8 الي 10 دقائق فقط ويكون بعدها جاهز للتقديم.
                             </p>
                        </div>
                ...
                <Slider {...settings}>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/4", previous:{name: "/ar/ahlia/4", previous: this.props.location.previous.name}}} exact> <img src={riceDafa} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/5", previous:{name: "/ar/ahlia/4", previous: this.props.location.previous.name}}} exact> <img src={riceGhassen} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/3", previous:{name: "/ar/ahlia/4", previous: this.props.location.previous.name}}} exact> <img src={riceMonafes} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/6", previous:{name: "/ar/ahlia/4", previous: this.props.location.previous.name}}} exact> <img src={riceWatani} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/1", previous:{name: "/ar/ahlia/4", previous: this.props.location.previous.name}}} exact> <img src={riceWhite} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   <NavLink to={{pathname:"/ar/ahlia/2", previous:{name: "/ar/ahlia/4", previous: this.props.location.previous.name}}}exact> <img src={riceSakhaa} alt={altImg} /></NavLink>
                    </div>
                    <div>
                   {/* <NavLink to={{pathname:"/ar/ahlia/7", previous:{name: "/ar/ahlia/4", previous: this.props.location.previous.name}}}exact> <img src={riceSamaha} alt={altImg} /></NavLink> */}
                    </div>
