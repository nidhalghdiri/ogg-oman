...
import FooterSection from '../../../containers/footer/FooterEn';
...
let nav = (
    <div className={classes.Link}>
              ...
              >Pasta </Link>
                ...
                duration={500}
              >Oil</Link>
                            {/* <NavLink to="/en/oil" exact>زيت</NavLink> */}
                        </li>
                        <li>
...
if(this.state.toggle){
    nav = <NavbarEn show={this.state.toggle} lien={true} color="rgba(29, 25, 107, 0.8)" lang={lang} />;
}
